...
public final class CloudStorageIcons {
  ...
  private static Icon load(String path) {
    return IconLoader.getIcon(path, CloudStorageIcons.class);
  }

  private static Icon loadGif(String path) {
    return new ImageIcon(CloudStorageIcons.class.getResource(path));
  }

  private CloudStorageIcons() {
