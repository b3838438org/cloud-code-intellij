...
public final class GcsToolWindowAction extends DumbAwareAction {
  ...
  public GcsToolWindowAction() {
    super(
        CloudStorageMessageBundle.message("gcs.tools.menu.action.text"),
        CloudStorageMessageBundle.message("gcs.tools.menu.action.description"),
        CloudStorageIcons.CLOUD_STORAGE);
  }
