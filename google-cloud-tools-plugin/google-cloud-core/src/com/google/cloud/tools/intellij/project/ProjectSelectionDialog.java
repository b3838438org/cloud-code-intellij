...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    centerPanel.setLayout(new GridLayoutManager(3, 3, new Insets(5, 5, 0, 5), -1, -1));
    centerPanel.setMinimumSize(new Dimension(500, 200));
    centerPanel.setPreferredSize(new Dimension(700, 496));
    centerPanel
    ...
    centerPanel.add(label1,
        new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
            ...
            false));
    centerPanel.add(accountComboBox, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER,
    ...
    label2.setText("Search by Name or ID:");
    centerPanel.add(label2,
        new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
            GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0,
            false));
    centerPanel.add(filterTextField, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST,
        GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW,
    ...
    centerPanel.add(scrollPane1,
        new GridConstraints(2, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
            ...
            null, null, 0, false));
    scrollPane1.setViewportView(projectListTable);
  }
