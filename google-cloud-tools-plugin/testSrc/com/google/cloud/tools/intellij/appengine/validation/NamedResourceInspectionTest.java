...
public class NamedResourceInspectionTest extends EndpointTestBase {
   ...
   * NamedResourceInspection.Error.DUPLICATE_PARAMETER} for an @Named annotation updates the query
   * name by adding "_1" as a suffix.
   */
  ...
  /**
   * Tests that the NamedResourceInspection's quick fix flagged with {@link
   * NamedResourceInspection.Error.MISSING_NAME} for an @Named annotation with no parent updates the
   * query name to "myName".
   */
  ...
  /**
   * Tests that the NamedResourceInspection's quick fix flagged with {@link
   * NamedResourceInspection.Error.MISSING_NAME} for an @Named annotation with a {@link
   * PsiParameter} parent updates the query name to to the name of the {@link PsiParameter}.
   */
