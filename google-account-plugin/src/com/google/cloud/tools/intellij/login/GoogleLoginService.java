...
public interface GoogleLoginService {
  ...
  /**
   * When the login menu item is instantiated by the UI, it calls this method so that when logIn()
   * is called by something other than the login menu item itself, the login menu item can be
   * notified to update its UI.
   *
